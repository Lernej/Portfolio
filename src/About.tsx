...
const About = () => {
  ...
  const captionList = [
    "Me in front of UCF's engineering building during admitted students day",
    "My family and I during High School Graduation",
    "My family and I during my Cross Country Senior Night Meet",
  ];

  return (
    <div className="pt-20 min-h-screen flex items-center justify-center lg:pt-0">
      <div className="text-image h-full bg-gray-950 text-white flex flex-col items-center  lg:flex-row justify-center">
          ...
          <div className="h-full flex flex-col text-center items-center justify-center pl-10 pr-10 gap-10 flex-1">
            ...
            <div>
              ...
              <p className="text-left text-xl">
                ...
                Science Principles and AP Computer Science A gave me the chance
                to explore this interest. The excitement I felt while working on
                projects in those classes confirmed that I wanted to study CS in
                college.
              </p>
            </div>
            <div>
        ...
        <PopInDiv duration={200} direction="left">
          {" "}
          <div className="flex-1 p-10 lg:p-40">
